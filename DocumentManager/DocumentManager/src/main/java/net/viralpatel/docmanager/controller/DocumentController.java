...
import net.viralpatel.docmanager.util.HibernateUtil;
...
public class DocumentController {
	...
	public String save(
		...
		try {
			Blob blob =Hibernate.getLobCreator(HibernateUtil.getSessionFactory().getCurrentSession()).createBlob(file.getInputStream(), 0);
